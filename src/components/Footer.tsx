...
export default function Footer() {
  return (
    <footer className="bg-white text-zinc-900 pt-24 pb-12 px-6 md:px-20 bg" id="main-footer">
      <div className="max-w-7xl mx-auto" id="footer-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24" id="footer-top">
          <div className="space-y-8 text-white" id="footer-brand">
            ...
            <div className="space-y-4">
               ...
               <div className="flex flex-col gap-2">
                 <input 
                   ...
                   className="w-full text-white border-b border-zinc-300 py-2 focus:border-black transition-colors outline-none"
                   id="newsletter-input"
                 />
          ...
          <div className="space-y-6 md:ml-20" id="footer-links ">
            <div className="flex flex-col gap-4 text-sm text-white font-medium">
          ...
          <div className="space-y-6 text-white" id="footer-contact">
          ...
          <div className="space-y-8 flex flex-col items-start lg:items-end justify-between" id="footer-social">
            {/* <div className="flex gap-4">
              <a href="#" className="p-2 border border-zinc-200 rounded-full hover:bg-black hover:text-white transition-all"><Linkedin className="w-4 h-4" /></a>
              <a href="#" className="p-2 border border-zinc-200 rounded-full hover:bg-black hover:text-white transition-all"><Twitter className="w-4 h-4" /></a>
              <a href="#" className="p-2 border border-zinc-200 rounded-full hover:bg-black hover:text-white transition-all"><Facebook className="w-4 h-4" /></a>
              <a href="#" className="p-2 border border-zinc-200 rounded-full hover:bg-black hover:text-white transition-all"><Instagram className="w-4 h-4" /></a>
            </div> */}
          </div>
        </div>
